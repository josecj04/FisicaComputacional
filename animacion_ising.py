...
# Parámetros
# ========================================
file_in = "imagenfinalHopfield.dat" # Nombre del fichero de datos 
file_out = "15Multinicial" # Nombre del fichero de salida (sin extensión)
...
# Calcula el nº de frtogramas o instantes de tiemp
